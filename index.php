...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-expand-lg bg-warning fixed-top" role="navigation" style="margin-bottom: 0">
      ...
      <div style="color: #333; padding: 15px 20px 15px 20px; float: right;font-size: 16px;"> 
        ...
        <a href="index.php?page=signout" style="color: #333;"><i class="fa fa-user" data-toggle="tooltip" title="signout"></i></a>
    </nav>   
    <!-- /. NAV TOP  -->
